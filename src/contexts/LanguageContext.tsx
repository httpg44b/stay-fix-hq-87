...
const translations = {
  pt: {
    ...
    'tickets.clearFilter': 'Limpar filtro',
    'ticket.title': 'Título',
    ...
    'ticket.hideFromRecepcao': 'Masquer à la réception',
    'ticket.showToRecepcao': 'Afficher à la réception',
    'ticket.hiddenToast': 'Appel masqué',
    'ticket.hiddenToastDesc': 'L\'appel a été masqué pour les utilisateurs de la réception.',
    'ticket.visibleToast': 'Appel visible',
    'ticket.visibleToastDesc': 'L\'appel est à nouveau visible pour la réception.',
    'tickets.showHidden': 'Voir masqués',
    'tickets.hideHidden': 'Masquer cachés',
    'errors.toggleVisibility': 'Erreur',
    'errors.toggleVisibilityDesc': 'Impossible de modifier la visibilité de l\'appel.',
  ...
  en: {
    ...
    'tickets.selectTechnician': 'Select technician',
    'tickets.noTechnician': 'No technician',
    'tickets.clearFilter': 'Clear filter',
    'ticket.title': 'Title',
    'ticket.status': 'Status',
    ...
    'ticket.hideFromRecepcao': 'Hide from reception',
    'ticket.showToRecepcao': 'Show to reception',
    'ticket.hiddenToast': 'Ticket hidden',
    'ticket.hiddenToastDesc': 'The ticket has been hidden from reception users.',
    'ticket.visibleToast': 'Ticket visible',
    'ticket.visibleToastDesc': 'The ticket is now visible to reception again.',
    'tickets.showHidden': 'Show hidden',
    'tickets.hideHidden': 'Hide hidden',
    'errors.toggleVisibility': 'Error',
    'errors.toggleVisibilityDesc': 'Could not change ticket visibility.',
  ...
  fr: {
    ...
    'tickets.selectTechnician': 'Sélectionner un technicien',
    'tickets.noTechnician': 'Aucun technicien',
    ...
    'tickets.clearFilter': 'Effacer le filtre',
    'ticket.title': 'Titre',
    ...
    'common.imagesUploaded': 'Images envoyées',
    'common.imagesUploadedDesc': 'image(s) envoyée(s) avec succès',
    ...
    'errors.loadingTicket': 'Erreur lors du chargement de l\'appel',
    'errors.loadingTicketDesc': 'Une erreur s\'est produite lors du chargement de l\'appel.',
    ...
    'errors.uploadingVideo': 'Erreur lors de l\'envoi de la vidéo. Vérifiez que le fichier fait moins de 50MB.',
    ...
    'errors.updatingTicketDesc': 'Une erreur s\'est produite lors de la mise à jour de l\'appel.',
    'errors.error': 'Erreur',
    'errors.needHotelLink': 'Vous devez être lié à un hôtel pour créer des appels.',
    'errors.creatingTicket': 'Erreur lors de la création de l\'appel',
    'errors.creatingTicketDesc': 'Une erreur s\'est produite lors de la création de l\'appel.',
    
    // Ticket specific
    'ticket.ticketImages': 'Images de l\'Appel',
    'ticket.solutionRequired': 'Solution obligatoire',
    'ticket.solutionRequiredDesc': 'Les techniciens doivent fournir une solution avant de fermer l\'appel.',
    'ticket.updated': 'Appel mis à jour',
    'ticket.updatedDesc': 'Les modifications ont été enregistrées avec succès.',
    'ticket.createdSuccess': 'Appel créé avec succès',
    'ticket.createdForRoom': 'Appel pour la chambre',
    'ticket.wasCreated': 'a été créé',
    'ticket.createNewMaintenance': 'Créer un nouvel appel de maintenance',
    'ticket.ticketInfo': 'Informations de l\'Appel',
    'ticket.fillDetails': 'Remplir les détails du problème à résoudre',
    'ticket.roomAreaNumber': 'Numéro de Chambre/Zone',
    'ticket.roomAreaPlaceholder': 'Ex: 201, Réception, Piscine',
    'ticket.titlePlaceholder': 'Brève description du problème',
    'ticket.detailedDescription': 'Description Détaillée',
    'ticket.descriptionPlaceholder': 'Décrivez le problème avec le maximum de détails possible...',
    'ticket.photos': 'Photos',
    'ticket.addPhotos': 'Ajouter des Photos',
    'ticket.photosAdded': 'photo(s) ajoutée(s)',
    'ticket.photosVideos': 'Photos et Vidéos',
    'ticket.addMedia': 'Ajouter Photos/Vidéos',
    'ticket.videosAdded': 'vidéo(s) ajoutée(s)',
    'ticket.videoSizeLimit': 'Les vidéos doivent faire moins de 50MB. Formats acceptés: MP4, WebM, OGG, QuickTime',
